...
public class TakingTurnsQueueTests
{
    ...
    // ! Defect(s) Found: List was not defined as a Queue Array
    ...
    // ! Defect(s) Found: None Found here
    ...
    // * Run 10 times.
    // ? Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // ! Defect(s) Found: Original code did not account for infinite, which was fixed
    ...
    // ! Defect(s) Found: After code accounted for 0, I had to account for negative numbers which fixed this
